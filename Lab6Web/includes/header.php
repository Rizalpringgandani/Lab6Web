...
<head>
  ...
  <meta name="author" content="Rizal Pringgandani">
  <link rel="icon" href="https://avatars.githubusercontent.com/u/115872442?v=4" />
  ...
  <title>Project Praktikum 4 | Rizal Pringgandani</title>
</head>
  ...
  <nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="<?= $url == 'update' ? '../home' : ' home' ?>" class="flex items-center cursor-pointer">
        <img src="https://avatars.githubusercontent.com/u/115872442?v=4" class="h-8 mr-3 rounded-full" alt="Flowbite Logo" />
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Rizal Pringgandani</span>
      </a>
